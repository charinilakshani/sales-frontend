...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path: 'admininqurie/:customerId', component: AdmininqurieComponent},
      {path: 'send-materials-managment/:customerId', component: SendMaterialsManagmentComponent},
